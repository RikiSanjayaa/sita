...
class UserImportTemplateDownloadController extends Controller
{
    ...
    {
        $rows = [
            ['name', 'email', 'role', 'password', 'nim', 'prodi', 'angkatan', 'concentration', 'nik', 'supervision_quota'],
            ['Muhammad Akbar', 'akbar@sita.test', 'mahasiswa', '', '2210510001', '', '2022', 'Jaringan', '', ''],
            ['Dr. Budi Santoso', 'budi@sita.test', 'dosen', '', '', '', '', 'Sistem Cerdas', '7301010101010001', '12'],
